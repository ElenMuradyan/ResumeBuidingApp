...
export default function MagicButton ({text, htmlType = 'button', loading, onClick, disabled}: {text: string, htmlType?: "button" | "submit" | "reset"; loading?: boolean, onClick?: () => void, disabled?: boolean}) {
  return(
      ...
      disabled={disabled}
      type={htmlType} 
      className="relative m-4 inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50"
      >
