...
export default function ClassicTemplate ({data, theme }: {data: resume, theme: themeItems }) {
    ...
    return(
        <div
        id="resume-preview"
        className={`max-w-[full] bg-white mt-2 mx-auto font-serif shadow-md text-xs`}
        >
        <div
